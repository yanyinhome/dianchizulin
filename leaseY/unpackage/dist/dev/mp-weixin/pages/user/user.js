  ...
  return _c("view", { staticClass: "content" }, [
    _c("view", { staticClass: "header" }, [
      ...
      _c(
        ...
        [_c("image", { attrs: { src: "../../static/image/sz.png", mode: "" } })]
      ),
      _c("view", { staticClass: "avtor" }, [
        _c("image", {
          attrs: { src: _vm.info.head_src, mode: "", eventid: "656f7cdf-2" },
          on: {
            click: function($event) {
              _vm.uploadHead()
            }
    ...
    _c(
      ...
      [
        ...
        _c(
          ...
          {
            staticClass: "flexBox",
            attrs: { url: "../userPages/shopCy/shopCy", "hover-class": "none" }
          },
          [
            _c("text", [_vm._v("网店查验")]),
            _c("image", {
    ...
    _c("view", { staticClass: "btnBlue" }, [_vm._v("退出登录")])
  ])
}
var staticRenderFns = []
