...

{
  ...
  methods: {
    ...
    changeDc: function changeDc(e, id) {
      this.status = e.currentTarget.dataset.num;
    },
    // 打电话
    call: function call() {
      uni.makePhoneCall({
    ...
    _c(
      ...
      _vm._l(_vm.dc, function(item, index) {
        return _c(
          ...
          {
            key: index,
            class: ["left", _vm.status == index ? "cardBg" : ""],
            attrs: { "data-num": index, eventid: "264e3b2e-0-" + index },
            on: {
          ...
          [
            _c("view", { staticClass: "title", attrs: { "data-num": index } }, [
              _vm._v(_vm._s(item.name))
            ]),
            _c("view", { staticClass: "ts", attrs: { "data-num": index } }, [
