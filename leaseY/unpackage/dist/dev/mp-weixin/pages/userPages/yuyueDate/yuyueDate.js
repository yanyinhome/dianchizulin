...

{
  ...
  methods: {
    ...
    change: function change(str) {
      if (str == 'day') {
        this.status = 'day';
        this.price = Number(this.day) + Number(this.money);
      } else if (str == 'month') {
        this.status = 'month';
        this.price = Number(this.month) + Number(this.money);
      } else if (str == 'qu') {
        this.status = 'qu';
        this.price = Number(this.qu) + Number(this.money);
      } else if (str == 'hyear') {
        this.status = 'hyear';
        this.price = Number(this.hyear) + Number(this.money);
      } else if (str == 'year') {
        this.status = 'year';
        this.price = Number(this.year) + Number(this.money);
      }
    } },
          ...
          _c("view", { staticClass: "maskBox" }, [
            ...
            _c("view", { staticClass: "btn flexBox" }, [
              _c(
                "view",
                {
                  attrs: { "data-id": "1", eventid: "6216eee1-8" },
                  on: {
                    click: function($event) {
                      _vm.maskClick($event)
                    }
              ...
              _c(
                "view",
                {
                  attrs: { "data-id": "2", eventid: "6216eee1-9" },
                  on: {
                    click: function($event) {
                      _vm.maskClick($event)
                    }
