<template>
	<view class="content">
		...
		<view class="header">
			...
			<view class="avtor">
				<image :src="info.head_src" mode="" @click="uploadHead()"></image>
			</view>
		...
		<view class="list">
			...
			<navigator url="../userPages/myLease/myLease" hover-class="none" class="flexBox">
				<text>我的租赁</text>
				<image src="../../static/image/backR.png" mode=""></image>
			</navigator>
			...
			<navigator url="../userPages/sz/sz?tel" hover-class="none" class="flexBox">
				<text>修改电话</text>
				<image src="../../static/image/backR.png" mode=""></image>
			</navigator>
...
<!-- 			<navigator url="../userPages/shopCy/shopCy" hover-class="none" class="flexBox">
				<text>网店查验</text>
				<image src="../../static/image/backR.png" mode=""></image>
			</navigator> -->
			<navigator hover-class="none" class="flexBox">
				<text>联系我们</text>
				<image src="../../static/image/backR.png" mode=""></image>
			</navigator>
		</view>
